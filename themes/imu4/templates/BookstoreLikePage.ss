...
<div style=" "><img style="margin:0 auto 0 auto;" src="$ThemeDir/images/book.jpg" /></div>
...
<div style="float: left; width: 500px;">
	...
	<div style="float: left; width: 400px;">
	<p>Like us</p>
	  <div><fb:like-box profile_id="30003907737" width="500" stream="false" header="false" connections="16"></fb:like-box></div>
	</div>
	<div style="clear: both; height: 20px;"></div>
	<div style="float: left; width: 60px;">

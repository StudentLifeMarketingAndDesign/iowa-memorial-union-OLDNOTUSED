...
#main-image-wrapper {
	...
	<% control ContentImage.SetWidth(280) %>
...
<!-- <% control Children %> 
    ...
    <% if Title == NowFeatured %>
        	<% control EventItem %>
    

  			<div class="featured-event">
    		<img src="$EventThumbnail.URL" height="108" width="219" />
...
<% end_control %>
 ...
 <% if Title = NowFeatured %>
    <% control EventItem %>
        ...
        <div class="featured-event">
        	<% if EventThumbnail %>
            <a href="$Link"><img src="$EventThumbnail.URL" height="108" width="219" /></a>
            <% else %>
    		<a href="$Link">$EventImage.SetWidth(217)</a>
            <% end_if %>
        	<div class="description">
        	<h1><a href="$Link"><strong>$Title</strong></a><h2>
            <% if EventDateAlt %>
            $EventDateAlt,
            <% else %>
            ...
            <% end_if %>
                ...
                $EventTime, $EventLocation - <a href="$Link">[more]</a></h2></h1>
 ...
 <div id="social-media-wrapper">
    ...
    <img src="$ThemeDir/images/now2/stay-connected-title.png" class="title_image" />
        ...
        <ul>
            ...
            <li><a href="https://list.uiowa.edu/scripts/wa.exe?SUBED1=NOW-AT-IMU&A=1"><img src="$ThemeDir/images/now2/email_icon.png" /></a></li>
        </ul>
        
        <p style="font-size: 16px;">Connect to concerts, movies, lectures, and campus events via <a href="http://twitter.com/imubuddy">Twitter</a>, <a href="http://facebook.com/uiowa.imu">Facebook</a>, or <a href="https://list.uiowa.edu/scripts/wa.exe?SUBED1=NOW-AT-IMU&A=1">email</a>. We'll keep you posted regularly. Emails go out bi-weekly.
        <p> <a href="https://list.uiowa.edu/scripts/wa.exe?SUBED1=NOW-AT-IMU&A=1" style="text-decoration: none;">&raquo; Sign Up For Our Newsletter</a></p>

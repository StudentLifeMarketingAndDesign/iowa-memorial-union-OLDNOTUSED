...
<script>
  ...
  function loginnow() {
	  FB.login(function(response) {
		  ...
		  setTimeout("Element.hide('nofacebook');Element.hide('one');Element.show('two');Element.hide('three');Element.hide('four');", 100);
		}, {perms:'email,sms'});
  }
  function afterlike() {
  	setTimeout("Element.hide('nofacebook');Element.hide('one');Element.hide('two');Element.show('three');Element.hide('four');", 100);
  }
  function logoutnow() {
	...
	setTimeout("Element.hide('nofacebook');Element.hide('one');Element.hide('two');Element.hide('three');Element.show('four');", 100);
  }
  function startOver() {
  	setTimeout("Element.hide('nofacebook');Element.show('one');Element.hide('two');Element.hide('three');Element.hide('four');", 100);
	FB.logout(function(response) {
	   //user is now logged out
	});
  }
  function noFacebook() {
	Element.show('nofacebook');Element.hide('one');Element.hide('two');Element.hide('three');Element.hide('four');
  }
</script>
...
<div id="four" style="display: none; text-align: center;">
  <h2>That's all!</h2>
  <div style="margin-top: 50px; margin-bottom: 50px;">
  Congratulations! You are now connected to the IMU through Facebook and the IMU email listserv.<br />
  You get access to weekly contests, news, events, and more.<br />
  <br />
  <div style="font-size: 2.0em;"><a href="#" onClick="startOver();return false;">Back To Start</a></div>
  </div>
</div>
<div id="nofacebook" style="display: none; text-align: left; width: 500px; margin-left: 300px;">
  <div style="width: 500px;">
  <h2>No Facebook? Connect to our newsletter!</h2>
  $Form
  </div>
</div>
...
<div style="float: left; margin-left: 200px;"><div style="font-size: 1.2em;"><a href="#" onClick="noFacebook();return false;">Don't Have Facebook</a></div></div>
